...
class TaskCell: UITableViewCell {
    ...
    func currentTask(isCurrent: Bool) {
        ...
        self.nameLabel.textColor          = isCurrent ? UIColor.pdrTextColor()           : UIColor.pdrText30Color()
        self.remainingTimeLabel.textColor = isCurrent ? UIColor.pdrDarkBlueBottomColor() : UIColor.pdrText30Color()
    }
    
    func activeTaskNotCurrent() {
        
        self.backgroundColor     = UIColor.clear
        self.nameLabel.textColor = UIColor.pdrText30Color()
    }
